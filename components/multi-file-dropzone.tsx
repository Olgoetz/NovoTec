...
const ERROR_MESSAGES = {
  fileTooLarge(maxSize: number) {
    return `Die Datei ist zu groß. Die maximale Größe beträgt ${formatFileSize(
      maxSize
    )}.`;
  },
  fileInvalidType() {
  ...
  tooManyFiles(maxFiles: number) {
    return `Sie können höchstens ${maxFiles} Dateien hochladen.`;
  },
  fileNotSupported() {
    return "Die Datei wird nicht unterstützt.";
  },
};
      ...
      <div>
        <div className="flex flex-col gap-2">
          <div>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                ...
                <div className="text-gray-400">Drag & Drop or hier klicken</div>
              </div>
            </div>
          ...
          {value?.map(({ file, progress }, i) => (
            <div
              key={i}
              className="flex h-16 w-full md:w-96 max-w-[100vw] flex-col justify-center rounded border border-gray-300 px-4 py-2"
            >
